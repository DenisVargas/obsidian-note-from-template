...
// import {  type TemplateField, type ReplaceType, type CreateType, type TemplateActionSettings, type ActiveTemplate, type TemplateResult, BAD_CHARS_FOR_FILENAMES_MATCH, BAD_CHARS_FOR_PATHS_MATCH } from './Shared'
// import { ensureArray } from './utils'

// // // @ts-expect-error - not sure how to build a proper typescript def yet
...
//         //WHY are we asking for defaults if this is the implementation class?
...
//         this.textReplacementTemplates = ensureArray(template_settings['template-replacement'], defaults.textReplacementTemplates),
...
//         const { data, template, textReplacementString } = spec
//         const { outputDirectory } = template

// 		//Copy data across to all the alternative formulations of a field
// 		this.fields.forEach( field => {
// 			field.alternatives.forEach( a => data[a] = data[field.id])
// 		})

//         //todo: Why first the body?
...
//         const filledTemplate = compile(this.templateBody);
//         data['templateResult'] = filledTemplate(data); 
...
//         const raw_foldername = Mustache.render(outputDirectory,data)
...
//         const replaceText = Mustache.render(textReplacementString,data)
